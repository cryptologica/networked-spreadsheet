//XmlWriter.h
//
// XmlWriter is a class to allow writing and XML type file
// Written by Damon Earl with the helpful tutorial and source code written by Oboltus

#ifndef XMLWRITER_H
#define XMLWRITER_H

// Disable MSVC warnings which are issued when using STL
#ifdef	_MSC_VER
